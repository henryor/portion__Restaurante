...
const products: Product[] = [
  { id: 1, name: "Pizza Margherita", description: "Tomate, mozzarella, albahaca", fullPrice: 10000, halfPrice: 6000, image: "/?height=100&width=100" },
  { id: 2, name: "Pasta Carbonara", description: "Espaguetis, huevo, panceta, queso", fullPrice: 12000, halfPrice: 7000, image: "/?height=100&width=100" },
  { id: 3, name: "Ensalada César", description: "Lechuga, pollo, crutones, aderezo César", fullPrice: 8000, halfPrice: 5000, image: "/?height=100&width=100" },
  { id: 4, name: "Tiramisú", description: "Postre italiano con café y mascarpone", fullPrice: 6000, halfPrice: 4000, image: "/?height=100&width=100" },
  ...
  return (
    <div className="container mx-auto p-4 flex flex-col lg:flex-row gap-8">
      <div className="w-full lg:w-2/3">
        {/* <h1 className="text-2xl md:text-3xl font-bold mb-6">---------------------</h1> */}
              ...
              <CardContent className="flex-grow">
                ...
                >
                  <div className="flex items-center space-x-2">
                    ...
                    <Label htmlFor={`full-${product.id}`} className="text-sm">Completa</Label>
                  </div>
                  <div className="flex items-center space-x-2">
                    <RadioGroupItem value="half" id={`half-${product.id}`} />
                    <Label htmlFor={`half-${product.id}`} className="text-sm">Media</Label>
                  </div>
                </RadioGroup>
              </CardContent>
              <CardFooter>
          ...
          <CardContent>
            <ScrollArea className="h-[50vh] lg:h-[60vh]">
              {cart.length === 0 ? (
                ...
                cart.map(item => (
                  <div key={`${item.id}-${item.portion}`} className="flex items-center justify-between mb-4 text-sm">
